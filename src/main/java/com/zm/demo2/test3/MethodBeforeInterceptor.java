...
public class MethodBeforeInterceptor implements BeanPostProcessor {
    ...
    // postProcessAfterInitialization方法内部会在service1初始化之后调用，内部会对service1这个bean进行处理，返回一个代理对象，
    // 通过代理来访问service1的方法，访问service1中的任何方法之前，会先输出：你好，service1
    @Nullable
    @Override
