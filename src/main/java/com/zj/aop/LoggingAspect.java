...
public class LoggingAspect {
    ...
    public void afterReturning(JoinPoint joinPoint, Object result) {
        System.out.println("[Aspect1] afterReturning advice");
    }
    ...
    public void afterThrowing(JoinPoint joinPoint, Exception ex) {
        System.out.println("[Aspect1] afterThrowing advice");
    }
    ...
    public Object around(ProceedingJoinPoint pjd) {
        ...
        try {
            //前置通知
            System.out.println("[Aspect1] around advice : start");
            result = pjd.proceed();
            //返回通知
            System.out.println("[Aspect1] around advice normal run");
        } catch (Throwable e) {
            //异常通知
            System.out.println("[Aspect1] around advice catch exception");
